...
urlpatterns = [
    ...
    path("auth/forgot-password-sms", auth_views.forgot_password_sms, name="forgot_password_sms"),
    path("auth/verify-reset-sms", auth_views.verify_reset_sms, name="verify_reset_sms"),
    path("auth/reset-password/validate", auth_views.reset_password_validate, name="reset_password_validate"),
