...
import heroImage from '@/assets/login-hero-image.jpg';

const TestimonialSection = () => {
  return (
    <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-teal to-brand-teal-dark relative overflow-hidden">
      {/* Background Image */}
      <div 
