...
const SocialButton = ({
  ...
  const buttonProps = {
    className:
      'flex items-center justify-center py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed w-full',
    disabled: pending,
    ...
    <>
      ...
      <div className={`mt-4 grid ${gridCols} gap-3`}>
        {enabled.includes('google') && (
          <GoogleButton onClick={onSocial} pending={pending} />
        )}
